// generated with metadata generator for devlens for fv ^1.3.0
...
/**
 * Root object used for interacting with the devlens API. `Client` has `query` and `mutation` functions for executing raw GraphQL queries and mutations, as well as `ModelManager` objects for manipulating models with a JavaScript API. `Client` also has a `fetch` function for making raw requests to your backend.
 * */
export class Client implements AnyClient {
  ...
  */
   ...
   */
  apiRoots: Record<string, string> = {"development":"https://devlens--development.gadget.app/","production":"https://devlens.gadget.app/"};



  applicationId: string = "198164";
  environment!: string;
  ...
  constructor(readonly options?: ClientOptions | undefined) {
    ...
    if (this.apiRoots[this.environment]) {
      ...
      apiRoot = `https://devlens${envPart}.gadget.app`;
    }
