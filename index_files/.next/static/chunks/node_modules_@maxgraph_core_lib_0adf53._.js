(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/node_modules_@maxgraph_core_lib_0adf53._.js", {

"[project]/node_modules/@maxgraph/core/lib/Client.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
 ...
 */ Client.NO_FO = typeof window !== 'undefined' && (!document.createElementNS || document.createElementNS(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$maxgraph$2f$core$2f$lib$2f$util$2f$Constants$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["NS_SVG"], 'foreignObject').toString() !== '[object SVGForeignObjectElement]' || navigator.userAgent.indexOf('Opera/') >= 0);
/**
...
"[project]/node_modules/@maxgraph/core/lib/serialization/ObjectCodec.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
 ...
 */ class ObjectCodec {
     ...
     */ isExcluded(obj, attr, value, write) {
        return attr == __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$maxgraph$2f$core$2f$lib$2f$util$2f$ObjectIdentity$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].FIELD_NAME || this.exclude.indexOf(attr) >= 0;
    }
    /**
     ...
     */ encodeObject(enc, obj, node) {
        ...
        for(const i in obj){
            ...
            if (value != null && !this.isExcluded(obj, name, value, true)) {
                if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$maxgraph$2f$core$2f$lib$2f$util$2f$mathUtils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isInteger"])(name)) {
                    name = null;
                }
     ...
     */ encodeValue(enc, obj, name, value, node) {
        if (value != null) {
            ...
            if (name != null && this.isReference(obj, name, value, true)) {
                ...
                if (tmp == null) {
                    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$maxgraph$2f$core$2f$lib$2f$util$2f$config$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["GlobalConfig"].logger.warn(`ObjectCodec.encode: No ID for ${this.getName()}.${name}=${value}`);
                    return; // exit
                }
                value = tmp;
            }
     ...
     */ writeComplexAttribute(enc, obj, name, value, node) {
        ...
        if (child != null) {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$maxgraph$2f$core$2f$lib$2f$util$2f$config$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["GlobalConfig"].logger.warn(`ObjectCodec.encode: No node for ${this.getName()}.${name}: ${value}`);
        }
    }
    /**
     ...
     */ isNumericAttribute(dec, attr, obj) {
        ...
        return obj.constructor === __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$maxgraph$2f$core$2f$lib$2f$view$2f$geometry$2f$Geometry$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"] && (attr.name === 'x' || attr.name === 'y' || attr.name === 'width' || attr.name === 'height') || obj.constructor === __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$maxgraph$2f$core$2f$lib$2f$view$2f$geometry$2f$Point$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"] && (attr.name === 'x' || attr.name === 'y') || (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$maxgraph$2f$core$2f$lib$2f$util$2f$mathUtils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isNumeric"])(attr.value);
    }
    /**
     ...
     */ decodeAttribute(dec, attr, obj) {
        if (!this.isIgnoredAttribute(dec, attr, obj)) {
            ...
            if (this.isReference(obj, fieldname, value, false)) {
                ...
                if (tmp == null) {
                    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$maxgraph$2f$core$2f$lib$2f$util$2f$config$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["GlobalConfig"].logger.warn(`ObjectCodec.decode: No object for ${this.getName()}.${name}=${value}`);
                    return; // exit
                }
                value = tmp;
            }
     ...
     */ decodeChildren(dec, node, obj) {
        ...
        while(child != null){
            ...
            if (child.nodeType === __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$maxgraph$2f$core$2f$lib$2f$util$2f$Constants$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["NODETYPE"].ELEMENT && !this.processInclude(dec, child, obj)) {
        ...
        if (fieldname == null || !this.isExcluded(obj, fieldname, child, false)) {
            ...
            if (child.nodeName === 'add') {
                ...
                if (value == null && ObjectCodec.allowEval) {
                    value = eval((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$maxgraph$2f$core$2f$lib$2f$util$2f$domUtils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getTextContent"])(child));
                }
            } else {
     ...
     */ processInclude(dec, node, into) {
        if (node.nodeName === 'include') {
            ...
            if (name != null) {
                try {
                    const xml = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$maxgraph$2f$core$2f$lib$2f$util$2f$MaxXmlRequest$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["load"])(name).getDocumentElement();
                    if (xml != null) {
                        dec.decode(xml, into);
                    }
                } catch (e) {
...
"[project]/node_modules/@maxgraph/core/lib/serialization/CodecRegistry.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$maxgraph$2f$core$2f$lib$2f$serialization$2f$ObjectCodec$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/node_modules/@maxgraph/core/lib/serialization/ObjectCodec.js [app-client] (ecmascript)");
;
/**
 ...
 */ class CodecRegistry {
     ...
     */ static getCodec(constructorOrName) {
        ...
        if (codec == null) {
            try {
                codec = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$maxgraph$2f$core$2f$lib$2f$serialization$2f$ObjectCodec$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"](new constructorOrName());
                CodecRegistry.register(codec);
            } catch (e) {
            // ignore
            }
...
"[project]/node_modules/@maxgraph/core/lib/serialization/Codec.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$maxgraph$2f$core$2f$lib$2f$serialization$2f$CodecRegistry$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/node_modules/@maxgraph/core/lib/serialization/CodecRegistry.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$maxgraph$2f$core$2f$lib$2f$util$2f$domUtils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/node_modules/@maxgraph/core/lib/util/domUtils.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$maxgraph$2f$core$2f$lib$2f$util$2f$config$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/node_modules/@maxgraph/core/lib/util/config.js [app-client] (ecmascript)");
 ...
 */ class Codec {
     ...
     */ getId(obj) {
        ...
        if (obj != null) {
            ...
            if (id == null && obj instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$maxgraph$2f$core$2f$lib$2f$view$2f$cell$2f$Cell$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"]) {
                id = obj.getId();
                if (id == null) {
                    // Uses an on-the-fly Id
                    id = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$maxgraph$2f$core$2f$lib$2f$view$2f$cell$2f$CellPath$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].create(obj);
                    if (id.length === 0) {
                        id = 'root';
                    }
                }
     ...
     */ encode(obj) {
        ...
        if (obj != null && obj.constructor != null) {
            const enc = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$maxgraph$2f$core$2f$lib$2f$serialization$2f$CodecRegistry$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].getCodec(obj.constructor);
            if (enc != null) {
                node = enc.encode(this, obj);
            } else if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$maxgraph$2f$core$2f$lib$2f$util$2f$domUtils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isNode"])(obj)) {
                node = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$maxgraph$2f$core$2f$lib$2f$util$2f$domUtils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["importNode"])(this.document, obj, true);
            } else {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$maxgraph$2f$core$2f$lib$2f$util$2f$config$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["GlobalConfig"].logger.warn(`Codec.encode: No codec for ${(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$maxgraph$2f$core$2f$lib$2f$util$2f$StringUtils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getFunctionName"])(obj.constructor)}`);
            }
        }
        return node;
    }
     ...
     */ decode(node, into) {
        this.updateElements();
        let obj = null;
        if (node != null && node.nodeType === __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$maxgraph$2f$core$2f$lib$2f$util$2f$Constants$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["NODETYPE"].ELEMENT) {
            const dec = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$maxgraph$2f$core$2f$lib$2f$serialization$2f$CodecRegistry$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].getCodecByName(node.nodeName);
            if (dec != null) {
     ...
     */ decodeCell(node, restoreStructures = true) {
        ...
        let decoder = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$maxgraph$2f$core$2f$lib$2f$serialization$2f$CodecRegistry$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].getCodec(node.nodeName);
        ...
        if (!this.isCellCodec(decoder)) {
            ...
            while(child != null && !this.isCellCodec(decoder)){
                decoder = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$maxgraph$2f$core$2f$lib$2f$serialization$2f$CodecRegistry$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].getCodec(child.nodeName);
                child = child.nextSibling;
            }
        }
        if (!this.isCellCodec(decoder)) {
            decoder = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$maxgraph$2f$core$2f$lib$2f$serialization$2f$CodecRegistry$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].getCodec(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$maxgraph$2f$core$2f$lib$2f$view$2f$cell$2f$Cell$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"]);
        }
...
"[project]/node_modules/@maxgraph/core/lib/gui/MaxPopupMenu.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
 ...
 */ class MaxPopupMenu extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$maxgraph$2f$core$2f$lib$2f$view$2f$event$2f$EventSource$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"] {
    constructor(factoryMethod){
         ...
         */ this.submenuImage = `${__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$maxgraph$2f$core$2f$lib$2f$Client$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].imageBasePath}/submenu.gif`;
        /**
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$maxgraph$2f$core$2f$lib$2f$view$2f$event$2f$InternalEvent$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].disableContextMenu(this.div);
    }
    /**
     ...
     */ isPopupTrigger(me) {
        return me.isPopupTrigger() || this.useLeftButtonForPopup && (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$maxgraph$2f$core$2f$lib$2f$util$2f$EventUtils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isLeftMouseButton"])(me.getEvent());
    }
    /**
     ...
     */ addItem(title, image, funct, parent = null, iconCls = null, enabled = true, active = true, noHover = false) {
        ...
        if (this.labels) {
            ...
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$maxgraph$2f$core$2f$lib$2f$util$2f$domUtils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["write"])(col2, title);
            col2.align = 'left';
            tr.appendChild(col2);
        ...
        if (active && enabled) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$maxgraph$2f$core$2f$lib$2f$view$2f$event$2f$InternalEvent$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].addGestureListeners(tr, (evt)=>{
            ...
            if (!noHover) {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$maxgraph$2f$core$2f$lib$2f$view$2f$event$2f$InternalEvent$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].addListener(tr, 'mouseout', (_evt)=>{
                    tr.className = 'mxPopupMenuItem';
                });
            }
        }
     ...
     */ showSubmenu(parent, row) {
        if (row.div) {
            ...
            const offset = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$maxgraph$2f$core$2f$lib$2f$util$2f$styleUtils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getDocumentScrollOrigin"])(document);
            ...
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$maxgraph$2f$core$2f$lib$2f$util$2f$styleUtils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fit"])(row.div);
        }
    }
    /**
     ...
     */ popup(x, y, cell, evt) {
        if (this.div && this.tbody && this.factoryMethod) {
            ...
            while(this.tbody.firstChild){
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$maxgraph$2f$core$2f$lib$2f$view$2f$event$2f$InternalEvent$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].release(this.tbody.firstChild);
     ...
     */ hideMenu() {
        if (this.div) {
            ...
            this.containsItems = false;
            this.fireEvent(new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$maxgraph$2f$core$2f$lib$2f$view$2f$event$2f$EventObject$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"](__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$maxgraph$2f$core$2f$lib$2f$view$2f$event$2f$InternalEvent$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].HIDE));
        }
    }
    /**
...
//# sourceMappingURL=node_modules_%40maxgraph_core_lib_0adf53._.js.map