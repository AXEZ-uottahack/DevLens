...
.mxCellEditor {
  ...
  _background: url("../media/transparent.d58a6628.gif");
  border-color: #0000;
  border-style: solid;
...
div.mxWindow {
  ...
  _background: url("../media/window.d9cdec6f.gif");
...
td.mxWindowTitle {
  ...
  _background: url("../media/window-title.ce73bdc7.gif") repeat-x;
...
td.mxWindowPane button {
  ...
  _background: url("../media/button.03000f7f.gif") repeat-x;
  font-family: Arial;
  font-size: 8pt;
  padding: 2px;
  float: left;
