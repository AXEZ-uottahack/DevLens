/* [project]/node_modules/@maxgraph/core/css/common.css [app-client] (css) */
div.mxRubberband {
  position: absolute;
  overflow: hidden;
  border-style: solid;
...
.mxCellEditor {
  ...
  _background: url("/_next/static/media/transparent.d58a6628.gif");
  border-color: #0000;
  border-style: solid;
...
div.mxWindow {
  -webkit-box-shadow: 3px 3px 12px silver;
  -moz-box-shadow: 3px 3px 12px silver;
  ...
  _background: url("/_next/static/media/window.d9cdec6f.gif");
...
td.mxWindowTitle {
  ...
  _background: url("/_next/static/media/window-title.ce73bdc7.gif") repeat-x;
...
td.mxWindowPane button {
  ...
  _background: url("/_next/static/media/button.03000f7f.gif") repeat-x;
  font-family: Arial;
  font-size: 8pt;
  padding: 2px;
  float: left;
...
/*# sourceMappingURL=node_modules_%40maxgraph_core_css_common_b52d8e.css.map*/